...
namespace RogueLike
{
    public class InputState
    {
        ...
        public bool IsLeft(PlayerIndex? controllingPlayer)
        {
            ...
            return IsNewKeyPress(Keys.A, controllingPlayer, out playerIndex) || IsNewButtonPress(Buttons.DPadLeft, controllingPlayer, out playerIndex)
        ...
        public bool IsRight(PlayerIndex? controllingPlayer)
        {
            ...
            return IsNewKeyPress(Keys.D, controllingPlayer, out playerIndex) || IsNewButtonPress(Buttons.DPadRight, controllingPlayer, out playerIndex)
        ...
        public bool IsUp(PlayerIndex? controllingPlayer)
        {
            ...
            return IsNewKeyPress(Keys.W, controllingPlayer, out playerIndex) || IsNewButtonPress(Buttons.DPadUp, controllingPlayer, out playerIndex)
        ...
        public bool IsDown(PlayerIndex? controllingPlayer)
        {
            ...
            return IsNewKeyPress(Keys.S, controllingPlayer, out playerIndex) || IsNewButtonPress(Buttons.DPadDown, controllingPlayer, out playerIndex)
